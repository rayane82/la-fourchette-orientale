      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="w-full h-28 rounded-xl overflow-hidden border border-white/10 transition-all duration-500 mb-3 shadow-lg">
               <iframe 
            ...
            <a 
              ...
              className="text-[9px] text-[#D4AF37] font-black uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2"
            >
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="space-y-3 w-full">
              <div className="flex items-center gap-3 text-white group cursor-pointer">
                <div className="w-7 h-7 rounded-full bg-[#D4AF37]/20 flex items-center justify-center text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-white transition-all">
                  <MessageCircle size={12} />
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] text-stone-500 uppercase tracking-tighter">WhatsApp</span>
                  <span className="text-sm font-bold tracking-wider">0770-454031</span>
                </div>
              </div>
              <div className="flex items-center gap-3 text-white group cursor-pointer">
                <div className="w-7 h-7 rounded-full bg-white/5 flex items-center justify-center text-white/50 group-hover:bg-white group-hover:text-[#042D1E] transition-all">
                  <Phone size={12} />
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] text-stone-500 uppercase tracking-tighter">Fixe</span>
                  <span className="text-sm font-bold tracking-wider">0536-680010</span>
                </div>
              </div>
              <div className="flex items-center gap-3 text-white group cursor-pointer">
                <div className="w-7 h-7 rounded-full bg-white/5 flex items-center justify-center text-white/50 group-hover:bg-[#D4AF37] group-hover:text-white transition-all">
                  <Mail size={12} />
                </div>
                <div className="flex flex-col">
                  <span className="text-[10px] text-stone-500 uppercase tracking-tighter">E-mail</span>
                  <span className="text-[11px] font-bold truncate max-w-[160px]">fourchetteorientale.ma@gmail.com</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-3 mb-6">
              <a 
                href="https://www.instagram.com/fourchetteorientale.ma" 
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2.5 bg-white/5 rounded-xl hover:bg-[#D4AF37] hover:text-white transition-all border border-white/5 group"
              >
                <Instagram size={16} className="group-hover:scale-110 transition-transform" />
              </a>
              <a 
                href="https://www.facebook.com/fourchetteorientale.ma" 
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2.5 bg-white/5 rounded-xl hover:bg-[#D4AF37] hover:text-white transition-all border border-white/5 group"
              >
            ...
            <div className="flex items-start gap-3 bg-black/20 p-4 rounded-xl border border-[#D4AF37]/10 w-full">
               ...
               <p className="text-[9px] italic leading-relaxed text-stone-400">
                "Un moment de partage sincère, comme à la maison."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col items-center relative">
          ...
          <button 
            ...
            className="opacity-[0.03] hover:opacity-20 transition-opacity duration-500 absolute bottom-0 right-0 p-4 cursor-default"
            aria-hidden="true"
          >
